...
const ChartRenderer: React.FC<ChartRendererProps> = ({
  ...
  if (!ChartComponent) {
    return (
      <div
        className="chart-error p-4 flex items-center justify-center bg-red-50 border border-red-200 rounded-md text-red-700 h-full w-full"
  ...
  if (!data || data.length === 0) {
    return (
      <div
        className="chart-no-data p-4 flex items-center justify-center bg-gray-50 border border-gray-200 rounded-md text-gray-500 h-full w-full"
        style={{ minHeight: "200px" }}
      >
        <div className="text-center">
